abstract class AppStrings {
  ...
  static const appName = 'نِصاب';

  // =========================
  // Introduction
  // =========================

  static const introCard1Title = 'احتساب ذكي ودقيق';
  static const introCard1Description = ' يتم احتساب النصاب والحول بدقة وفق الاحكام الشرعية.';

  static const introCard2Title = 'كل أصولك في مكان واحد';
  static const introCard2Description = 
  'اضف اصولك الزكوية الاخرى ليتم احتسابها ضمن الزكاة المستحقة.';
  static const introCard3Title = 'اخراج الزكاه بخطوات سهلة';
  static const introCard3Description =
      'اعرف مقدار الزكاة المستحقة وأكمل الدفع بكل سهولة.';

  static const accept = 
      'أقر بأنني اطلعت على آلية احتساب الزكاة وأوافق على استخدامها.';

  static const introButton = 'ابدأ احتساب الزكاة';

    // Process
  static const processTitle = 'نحلّل بياناتك بأمان';
  static const processSubtitle =
      'نراجع المعلومات اللازمة لاحتساب زكاتك بدقة .';

  static const List<String> processSteps = [
    'جارٍ الاتصال بحسابك ',
    'جارٍ التحقق من البيانات المالية',
    'نحلّل الأصول والمبالغ الزكوية',
    'نجهّز ملخص احتساب الزكاة',
  ];

  static const List<String> processStepDetails = [
    'يتم إنشاء اتصال آمن ومشفّر مع بياناتك.',
    'نتأكد من اكتمال المعلومات المطلوبة للحساب.',
    'نرتّب بياناتك لتحديد الأموال الخاضعة للزكاة.',
    'اقتربنا من إظهار النتيجة النهائية لك.',
  ];
